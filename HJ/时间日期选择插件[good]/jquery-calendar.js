...
var popUpCal = {
    ...
    prevText: '&lt;preM', // Display text for previous month link
    nextText: 'nextM&gt;', // Display text for next month link
    currentText: 'nowD', // Display text for current month link
    ...
    dayNames: ['7', '1', '2', '3', '4', '5', '6'], // Names of days starting at Sunday
    monthNames: ['Mon  1', 'Mon  2', 'Mon  3', 'Mon  4', 'Mon  5', 'Mon  6', 'Mon  7', 'Mon  8', 'Mon  9', 'Mon  10', 'Mon  11', 'Mon  12'], // Names of months
    ...
    showTime: function() {
        ...
        if (this.timeSeparators.length > 1) {
            ...
            timeSelect += '<div id="CLD_OK">OK</div></div>';
        }
